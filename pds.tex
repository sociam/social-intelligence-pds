...
% PDSes need to be able to are represented have essentially emerged as application writers devised formats to suit their apps in a relatively \emph{ad-hoc} manner.  The consequence of this is that the app itself is usually required for reading.
